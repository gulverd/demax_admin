			...
			<div class="col-md-12 dashboard_buttons_main_wrp">
				<form method="post" action="" enctype="multipart/form-data">
					<div class="form-group">
						<label>სახელი</label>
						<input type="text" name="empName" class="form-control" placeholder="თანამშრომლის სახელი და გვარი">
					</div>
					<div class="form-group">
						<label>პოზიცია</label>
						<input type="text" name="empPosition" class="form-control" placeholder="თანამშრომლის პოზიცია">
					</div>
					<div class="form-group">
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_FILES['image'])){
			...
			if(empty($errors)==true){
			    ...
			    $query = "INSERT INTO team (empName,empPosition,about,empImage) VALUES ('$empName','$empPosition','$about','$fl_name')";
